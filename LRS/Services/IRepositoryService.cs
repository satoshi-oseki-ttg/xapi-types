...
namespace bracken_lrs.Services
{
    public interface IRepositoryService
    {
        ...
        Task<Statement> GetStatement(Guid? id, bool toGetVoided = false, IList<StringWithQualityHeaderValue> acceptLanguages = null);
        StatementsResult GetStatements(Uri verbId, IList<StringWithQualityHeaderValue> acceptLanguages);
        StatementsResult GetStatements(int limit, DateTime since, IList<StringWithQualityHeaderValue> acceptLanguages);
