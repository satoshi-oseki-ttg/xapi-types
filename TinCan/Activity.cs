...
namespace TinCan
{
    public class Activity : JsonModel, StatementTarget
    {
        ...
        public string objectType; // SO: Added this field for deserialisation
        public String ObjectType { get { return OBJECT_TYPE; } }

        private string _id;

        public string id; // SO: Added this for deserialisation
        public string Id // SO: Renamed this from id for deserialisation
        {
            get { return _id; }
            set
            {
                //?? Uri uri = new Uri(value); // not used just for checking format?
                _id = value;
            }
        }
        ...
        public Activity(JObject jobj)
        {
            if (jobj["id"] != null)
            {
                ...
                //?? Uri uri = new Uri(idFromJSON); // not used
                Id = idFromJSON;
            }
